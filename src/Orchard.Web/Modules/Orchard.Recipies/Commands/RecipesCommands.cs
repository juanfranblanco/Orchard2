...
namespace Orchard.Recipes.Commands {
    public class RecipesCommands : DefaultOrchardCommandHandler {
        ...
        public void Execute(string extensionId, string recipeName) {
            ...
            Context.Output.WriteLine(T("Recipe successfully scheduled with execution ID {0}. Use the 'recipes result' command to check the result of the execution.", executionId));
        }
